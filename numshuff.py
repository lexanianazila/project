...
def ambildurasi(data):
    return data[2]
def tampilkan_skor():
    print(colored("=== Skor Tertinggi ===", 'magenta'))
...
def program_utama():
    ...
    while True:
        ...
        if terselesaikan(board):
            ...
            tampilkan_papan(board)
            print(colored(f"asikk congrats yhh {nama}, km dh kelarin game naik tensi ni dalam {langkah} langkah trs cuma {durasi:.2f} detik. gacor sie >~<", 'magenta'))
